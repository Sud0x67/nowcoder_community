...
public class LoginController implements CommunityConstant {
    ...
    public String activate(Model model, @PathVariable("id") int id, @PathVariable("code") String code){
        int status = userService.activate(id, code);
        if(status == ACTIVATION_SUCCESS){
            model.addAttribute("msg", "激活成功，您的账号已经可以登陆了");
